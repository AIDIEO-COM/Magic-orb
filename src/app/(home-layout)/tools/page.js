...
const Tools = () => {
  ...
  const [animateToolsContent, setAnimateToolsContent] = useState("opacity-0 duration-700");
  ...
  return (
    <div className="grid justify-items-center md:justify-items-stretch pt-32 md:pt-0 md:grid-cols-2 gap-8 z-0 font-berlin p-3 md:p-4 lg:p-0 h-full ">
      <ToolsContent activeCard={activeCard} animateToolsContent={animateToolsContent}></ToolsContent>
      <div 
