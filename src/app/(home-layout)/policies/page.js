          ...
          <div className="text-xs tracking-wide text-[#DBCBF4] flex">
            ...
            <div>
              ...
              <article className="inline ml-0.5 text-[#E5BD9D]">
                ...
                terms and conditions outlined below. b. The content on our
                website is provided for informational and entertainment purposes
                only. It should not be considered a substitute for professional
                advice or treatment. c. We reserve the right to modify or
                discontinue any aspect of the website at any time without prior
                notice. d. Users must be at least 18 years old to use our
                website or have parental consent. e. We are not responsible for
                any actions taken based on the information provided on our
                website.
              </article>
            </div>
          </div>
          <div className="text-xs tracking-wide text-[#DBCBF4] flex">
            ...
            <div>
              ...
              <article className="inline ml-0.5 text-[#E5BD9D]">
                ...
                information, we make no warranties or representations regarding
                the completeness, accuracy, reliability, or suitability of the
                information provided. b. Users should independently verify any
                information before making decisions or taking any action based
                on it.
              </article>
            </div>
          </div>
          <div className="text-xs tracking-wide text-[#DBCBF4] flex">
            ...
            <div>
              ...
              <article className="inline ml-0.5 text-[#E5BD9D]">
                ...
                not be applicable to all individuals. b. We do not claim to have
                all the answers or to be infallible. Our advice should be taken
                as suggestions, and users are encouraged to exercise their own
                discernment and judgment. c. Users are solely responsible for
                any decisions they make based on the spiritual advice provided
                on our website.
              </article>
            </div>
          </div>
