  ...
  return (
    <div className="font-berlin p-3 md:p-4 lg:p-0 h-[calc(100vh-60px)] ">
      ...
      <div className="flex gap-2 mt-8">
        <div className="flex items-center justify-between px-4 rounded-xl bg-[#221c3de0] shadow-[10px_10px_8px_10px_#00000024] grow">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-[#E5BD9D] text-[9px]">
        ...
        <div className="flex items-center justify-between px-4 rounded-xl bg-[#221c3de0] shadow-[10px_10px_8px_10px_#00000024] grow-0"></div>
        <div className="flex items-center justify-between px-4 rounded-xl bg-[#221c3de0] shadow-[10px_10px_8px_10px_#00000024] grow">
          <div className="flex flex-col items-center justify-center gap-y-2">
            <div className="flex flex-col">
              <p className="text-[#E5BD9D] font-bold text-2xl">Statistics</p>
              <span className="text-[#DBCBF4] text-[10px] tracking-wider text-center">
