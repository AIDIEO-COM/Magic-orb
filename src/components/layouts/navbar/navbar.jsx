...
const Navbar = ({toggleSidebar}) => {
    return (
        <div className="py-4 px-4 md:px-7 lg:px-14 bg-gradient-to-b from-[#3D2D3B] to-[#232141] flex items-center justify-between">
            ...
            {/* navbar content here */}
            <div className="w-[40%] h-7 bg-[#635B74] rounded-md py-[3px] px-2 font-berlin lg:flex justify-between hidden ">
            ...
            <div className="flex w-fit h-full items-center gap-4">
                <Image src={"https://i.ibb.co/RTPVZK9/notification-modified-1.png"} alt="notification-modified" width={28} height={28}></Image>
                <Image src={"https://i.ibb.co/HnQhpXc/Notifications.png"} alt="notification-modified" width={28} height={28}></Image>
            </div>
        </div>
    );
};
