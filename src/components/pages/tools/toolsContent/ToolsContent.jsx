...
const ToolsContent = ({
  ...
  return (
    <div
      className={`mx-auto w-[95%] max-w-[616px] -mt-28 border-r-2 sm:rotate-[3.00deg] bg-gradient-to-r from-[#442143] to-[#2B3057] lg:z-10 overflow-hidden h-full lg:h-[140%] ${animateToolsContent}} duration-700 `}
      style={{
        boxShadow:
