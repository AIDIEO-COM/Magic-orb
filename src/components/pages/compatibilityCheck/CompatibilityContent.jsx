    ...
    <div className=" w-full h-full lg:p-7 xl:p-10 lg:overflow-hidden">
      <div className="left-1/2 -translate-x-1/2 w-full flex flex-col items-center absolute top-5 lg:relative lg:top-auto">
        ...
        <div className="mt-3 flex flex-col items-center">
          ...
          <button className="bg-[#674B53] text-[#E5BD9D] px-[11px] py-1 rounded-3xl mt-4 text-sm">Check soulmates</button>
        </div>
      </div>
      <div className="h-full w-full flex flex-col items-center md:items-start  md:flex-row justify-center gap-10 sm:gap-20 lg:gap-0 lg:justify-between pt-10 ">
        <div className="w-[85%] sm:w-[60%] md:w-[27%] xl:w-[19%] default-shadow bg-[#20192A] h-[500px] rounded-[50px] px-3 py-4  text-[#FFC8AA] flex flex-col justify-between bg-opacity-60">
        ...
        <div className="w-[85%] sm:w-[60%] md:w-[27%] xl:w-[19%] default-shadow bg-[#20192A] h-[500px] rounded-[50px] px-3 py-4 text-[#FFC8AA] bg-opacity-60">
          <h1 className="text-base lg:text-3xl font-berlin text-center">
