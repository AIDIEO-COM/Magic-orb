...
const CompatibilityAds = ({ setIsPremiumClicked, isPremiumClicked }) => {
  return (
    <div
    ...
    >
      <div
        ...
        style={{ backgroundImage: `url(/ads-images/compatibility-ads.png)` }}
      ></div>
      <div className="col-start-3 col-end-6 h-full">
        ...
        <p className="text-[#FFC8AA] font-berlin text-[8px] sm:text-[15px] lg:text-[12px] 2xl:text-[15px]">
          Find the best partner for you Just one click away to meet
        </p>
...
export default CompatibilityAds;
