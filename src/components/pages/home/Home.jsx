  ...
  return (
    <div className="font-berlin p-3 md:p-4 lg:p-0 h-full">
        ...
        <div className="col-start-1 col-end-9 relative h-[280px] sm:h-auto">
          <Link href={"/magic-orb"}>
            ...
            data-aos="zoom-out-left"
              ...
              width={1000}
              height={1000}
              className={`w-full object-cover sm:object-fill rounded-2xl sm:rounded-none default-shadow sm:shadow-none h-full duration-700 lg:pr-3 z-10`}
            ></Image>
      ...
      >
        ...
        >
          {disconnectReferenceImageCards.slice(0,2).map((singleImageCardInfo) => (
        ...
        >
          {disconnectReferenceImageCards.slice(2, 4).map((singleImageCardInfo) => (
            <ImageCard key={singleImageCardInfo.id} {...singleImageCardInfo} home={true}/>
          ))}
        </div>
      </div>
