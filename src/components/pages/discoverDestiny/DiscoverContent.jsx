    ...
    <div className=" w-full h-full lg:p-7 xl:p-10  relative">
      <div className="w-full flex flex-col items-center  relative">
        ...
        <button
          ...
          className={`text-[#E5BD9D] bg-[#674B53] absolute -bottom-[44px] px-3 text-sm lg:text-base rounded-full duration-700 ${selectRandomCards || selectedCards.length > 0 ? " hidden" : ""}`}
        >
          Select random cards
        </button>
      </div>
