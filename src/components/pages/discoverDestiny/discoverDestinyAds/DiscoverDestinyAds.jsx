...
const DiscoverDestinyAds = ({setIsPremiumClicked, isPremiumClicked, img, description, astrology}) => {
  return (
    <div
      className={`h-fit w-[95%] sm:w-[70%] mx-auto ${astrology ? 'mt-[150px]': 'mt-[20px]'} sm:mt-10 lg:mx-0 lg:mt-auto  lg:w-[33%] rounded-[38px] grid grid-cols-5 py-4 px-3.5 gap-4 ${isPremiumClicked && 'hidden'}`}
      style={{
...
export default DiscoverDestinyAds;
