...
const AstrologyContent = () => {
  ...
  return (
    <div className=" w-full h-full lg:p-7 xl:p-10 lg:overflow-hidden ">
      ...
      {/* content here */}
      <div className="w-full flex flex-col items-center md:items-start  md:flex-row justify-center gap-7 sm:gap-20 lg:gap-0 lg:justify-between pt-[190px] sm:pt-5 md:pt-10 lg:pt-0 h-full lg:h-[500px] ">
